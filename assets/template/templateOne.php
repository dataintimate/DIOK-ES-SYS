    ...
    <table class="example" cellspacing="0" cellpadding="0" width="652px"
        ...
        <tr>
            ...
            <td class="backgroundColor td2" style="position:relative; background-color: #f5f4f4; text-align: left; width: 500px; padding: 10px;">
                ...
                <p class="td2p" style="font-size: 13px; color: #7f5c5c;"><a style="font-size: 13px"><span id="mobileNo">+1 (555) 987-6543</span></a></p>
                <p class="td2p" style="font-size: 13px; color: #7f5c5c; margin-bottom: 3px;"><a style="font-size: 13px"><span id="officeNo">+1 (555) 123-4567</span></a></p>
